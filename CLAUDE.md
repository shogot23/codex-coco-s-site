...
- ブランド戦略、投稿制作、AI作業判断は `docs/brand/` 配下を参照する
...
- ブランド原典: `docs/brand/reading-with-coco-brand-strategy.md`
- 制作ガイドライン: `docs/brand/reading-with-coco-content-guidelines.md`
- AI運用ルール: `docs/brand/reading-with-coco-ai-operations.md`
- 最重要問い: この投稿は、読者の中に問いか行動を残しているか？
